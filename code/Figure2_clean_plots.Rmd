...
#1.008512	0.9998536	1.017365		#exponentiated
...
#and darken colors in forest plot so they can be seen in the figure
```{r}
...
```{r}
#old----
Fig2_a4<-plot_grid(rootnpp_vs_forest_soiln15_plot_log_axisa4, coral_sb_plota4, parrotfish_sb_plota4, labels = "AUTO", label_fontface = "bold", nrow = 1, label_size = 12, align = "hv", hjust = -2)


ggsave(Fig2_a4, filename = "../figures/Fig2_A4.jpg", width = 8.2, height = 3, units = "in")


Fig2_a4_vert<-plot_grid(rootnpp_vs_forest_soiln15_plot_log_axisa4, coral_sb_plota4, parrotfish_sb_plota4, align = "hv", labels = "AUTO", label_fontface = "bold", ncol = 1, label_size = 12, hjust = -2.2, vjust = 1.2)
...
##re-format-----
Fig2_formatted<-plot_grid(rootnpp_vs_forest_soiln15_plot_log_axisa4, coral_sb_plota4, parrotfish_sb_plota4, labels = "AUTO", label_fontface = "bold", nrow = 1, label_size = 9, align = "hv", hjust = -2, label_fontfamily = "Helvetica")
Fig2_formatted

ggsave(Fig2_formatted, filename = "../figures/Fig2_formatted.pdf", width = 7.25, height = 2.8, units = "in", dpi = 600)
ggsave(Fig2_formatted, filename = "../figures/Fig2_formatted.svg", width = 7.25, height = 2.8, units = "in", dpi = 600)
