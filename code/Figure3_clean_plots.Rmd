...
#create nice plot for fig3 to combine with marine data:
```{r}
...
```{r}
###old----
Fig3<-plot_grid(coral_energy_prod_plota4, parrot_energy_sed_plot_log_axisa4, root_length_prod_plota4, labels = "AUTO", label_fontface = "bold", nrow = 1, align = "v", label_size = 12, hjust = c(0, .75, -2.5), vjust = 1.2, scale =.99)
Fig3

ggsave(Fig3, filename = "../figures/Fig3_A4.jpg", width = 8.2, height = 3)

##vertical:
Fig3_vert<-plot_grid(coral_energy_prod_plota4, parrot_energy_sed_plot_log_axisa4, root_length_prod_plota4, labels = "AUTO", label_fontface = "bold", ncol = 1,  label_size = 12, hjust =c(-2.75, -2.75, -2.75), vjust = c(1.25, .5, .5))
Fig3_vert

ggsave(Fig3_vert, filename = "../figures/Fig3_A4_vert.jpg", width = 3.5, height = 8)

##correct formatting-----
Fig3_formatted<-plot_grid(coral_energy_prod_plota4, parrot_energy_sed_plot_log_axisa4, root_length_prod_plota4, labels = "AUTO", label_fontface = "bold", nrow = 1, label_size = 9, align = "hv", hjust = -2, label_fontfamily = "Helvetica")
Fig3_formatted

ggsave(Fig3_formatted, filename = "../figures/Fig3_formatted.pdf", width = 7.25, height = 2.8, units = "in", dpi = 600)
ggsave(Fig3_formatted, filename = "../figures/Fig3_formatted.svg", width = 7.25, height = 2.8, units = "in", dpi = 600)
